...
import { Button, Datepicker, Label, Modal, Table, Textarea } from "flowbite-react";
...
import { createNetSurplus, deleteNetSurplus, getNetSurplus } from "../services/api/netSurplusApi";
          ...
          <Table>
            ...
            <Table.Body className="divide-y">
              ...
              {netSurplus.map((item, i) => (
                ...
                >
                  <Table.Cell>
                    <Moment format="DD MMM YYYY">{item.start_date}</Moment>{" s/d "}
