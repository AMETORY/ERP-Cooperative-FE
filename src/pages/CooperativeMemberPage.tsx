...
import { MemberInvitationModel } from "../models/member";
...
const CooperativeMemberPage: FC<CooperativeMemberPageProps> = ({}) => {
  ...
  const [member, setMember] = useState<CooperativeMemberModel | null>(null);
  ...
  const getAllMembers = async () => {
    try {
      setLoading(true);
      const resp: any = await getCooperativeMembers({ page, size, search });
...
export default CooperativeMemberPage;
